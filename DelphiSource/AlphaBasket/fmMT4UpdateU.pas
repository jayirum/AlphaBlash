...
begin
  ...
  begin
    ...
    //TODO  lblWarning.Caption    := fmMain.ML.GetTranslatedText('WARN_CLOSE_MT4');
...
begin
  ...
  try
    ...
    begin
      ...
      if KillID>0 then
      begin
        //TODO ShowMessage(fmMain.ML.GetTranslatedText('ERR_NONE_KILLED_TERMINAL'));
        exit;
      end;
    end;
    ...
    if error then
    begin
      //TODO ShowMessage(fmMain.ML.GetTranslatedText('ERR_COPY_MT4FILES'));
      Exit;
    end
    else
    begin
      ...
      fmMain.SG1.Cells[1, m_MT4Index +1]  := fmMain.MT4Info[m_MT4Index].StateStr;

      //TODO ShowMessage(fmMain.ML.GetTranslatedText('SUCC_COPY_MT4FILES'));
...
begin
  ...
  Caption := 'Update MT4/5 (' + fmMain.MT4Info[m_MT4Index].ExePath + ')';

  //TODO chkRunMT4.Caption :=  fmMain.ML.GetTranslatedText('WANT_RUN_MT4');
