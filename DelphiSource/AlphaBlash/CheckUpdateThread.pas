...
begin
  ...
  begin
    ...
    try
      ...
      fmMain.AddMsg(fmMain.ML.GetTranslatedText('ERR_DOWNLOAD_FILES'), true, true);
...
begin
  ...
  begin
    ...
    begin
      fmMain.AddMsg(fmMain.ML.GetTranslatedText('MSG_START_DOWNLOAD'), false, false);
      Synchronize(ShowProgressBar);
      DownloadFiles();
      Synchronize(HideProgressBar);
      fmMain.AddMsg(fmMain.ML.GetTranslatedText('MSG_COMPLETE_DOWNLOAD'), false, false);
