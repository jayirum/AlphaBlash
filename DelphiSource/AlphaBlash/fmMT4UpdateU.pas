...
begin
  ...
  begin
    ...
    lblWarning.Caption    := fmMain.ML.GetTranslatedText('WARN_CLOSE_MT4');
...
begin
  ...
  try
    ...
    begin
      ...
      if KillID>0 then
      begin
        ShowMessage(fmMain.ML.GetTranslatedText('ERR_NONE_KILLED_TERMINAL'));
        exit;
      end;
    end;
    ...
    if error then
    begin
      ShowMessage(fmMain.ML.GetTranslatedText('ERR_COPY_MT4FILES'));
      Exit;
    end
    else
    begin
      ...
      ShowMessage(fmMain.ML.GetTranslatedText('SUCC_COPY_MT4FILES'));
...
begin
  ...
  chkRunMT4.Caption :=  fmMain.ML.GetTranslatedText('WANT_RUN_MT4');
