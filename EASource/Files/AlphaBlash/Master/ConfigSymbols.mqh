...
public:
    ...
    int     AddSymbolsByTr(string sSymbols);
    int     AddSymbols(char& pzPacket[], int nRecvLen);
...
int CConfigSymbol::AddSymbolsByTr(string sSymbols)
{
   string arrSymbol[];
...
int CConfigSymbol::AddSymbols(char& pzPacket[], int nRecvLen)
{
