...
//
public: 
   bool  PlaceMarketOrder_Open(_Out_ int& oTicket,  string sSymbol, int nCmd, double dVol, int nSlippage,
                              double dSL, double dTP, string sComment=NULL, int nMagic=0, datetime dtExpiration=0, 
                              int nWaitSec=1, int nRetryCnt=3, double dPrc=0);
...
private: 
   bool   PlaceMarketOrder_Open_MT4(_Out_ int& oTicket,  string sSymbol, int nCmd, double dVol, int nSlippage, double dSL, double dTP, string sComment=NULL, int nMagic=0, datetime dtExpiration=0, int nWaitSec=1, int nRetryCnt=3, double dPrc=0);
...
bool COrderHandler::PlaceMarketOrder_Open_MT4(_Out_ int& oTicket,  string sSymbol, int nCmd, double dVol, int nSlippage, 
                                          double dSL, double dTP, string sComment, int nMagic, datetime dtExpiration, int nWaitSec, int nRetryCnt, double dPrc=0)
{
