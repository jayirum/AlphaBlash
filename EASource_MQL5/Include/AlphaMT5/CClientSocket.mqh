...
#import "ws2_32.dll"
   ...
   int setsockopt(SOCKET_HANDLE32, int, int, int&, int);
...
class ClientSocket
{
   ...
   public:
      ...
      ALPHA_RET RecvWithBuffering(_Out_ bool& bRecvData);
...
ALPHA_RET ClientSocket::RecvWithBuffering(_Out_ bool& bRecvData)
{
   bRecvData = false;
   if (!m_bConnected)
   {
