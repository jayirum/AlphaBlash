...
#else 
      !__IsNumberAscii(StringGetCharacter(sStartLogging,0)) ||
      !__IsNumberAscii(StringGetCharacter(sStartLogging,1)) ||  
      !__IsNumberAscii(StringGetCharacter(sStartLogging,3)) ||
      !__IsNumberAscii(StringGetCharacter(sStartLogging,4)) ||

      !__IsNumberAscii(StringGetCharacter(sStopLogging,0)) ||
      !__IsNumberAscii(StringGetCharacter(sStopLogging,1)) ||
      !__IsNumberAscii(StringGetCharacter(sStopLogging,3)) ||
      !__IsNumberAscii(StringGetCharacter(sStopLogging,4))
#endif      
      )
   {
      Alert("Please input the valid time");
