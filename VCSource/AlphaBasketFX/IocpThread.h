...
private:
	...
	HANDLE			m_hThread_Listen, m_hThread_OrderSend, m_hNoMoreOpenThread, m_hWorkerThread, m_hParsing;
	unsigned int	m_unThread_Listen, m_unThread_OrderSend, m_unNoMoreOpenThread, m_unWorkerThread, m_unParsing;
