...
int main(int argc, LPWSTR* argv)
{
	...
	CUtil::GetConfig(g_zConfig, TEXT("DIR"), TEXT("LOG"), szDir);

	TCHAR zSvrName[32], zNotiIP[32], zNotiPort[32];
	CUtil::GetConfig(g_zConfig, TEXT("NOTIFICATION"), TEXT("MYSERVER_NAME"), zSvrName);
	CUtil::GetConfig(g_zConfig, TEXT("NOTIFICATION"), TEXT("NOTIFICATION_SERVER_IP"), zNotiIP);
	CUtil::GetConfig(g_zConfig, TEXT("NOTIFICATION"), TEXT("NOTIFICATION_SERVER_PORT"), zNotiPort);
	...
	CUtil::GetConfig(g_zConfig, TEXT("DEBUG"), TEXT("LOG_DEBUG"), msg);
