...
int  _Start()
{
	...
	//	GET LOG DIR
	if (g_bDebug)
		CUtil::GetMyModuleAndDir(g_zLogDir, msg, g_zConfig);
	else
		CUtil::GetCnfgFileNmOfSvc(SERVICENAME, g_zLogDir, g_zConfig);

	g_log.OpenLogWithAlerm(EXENAME, g_zLogDir, EXENAME);


	if (!g_csv.Open(g_zLogDir, "CompareLatency", "Data", false))
	{
		//TODO
		return -1;
	}

	g_csv.Column_Add("Symbol", false);
	g_csv.Column_Add("LocalTime", false);

	g_csv.Column_Add("BidBestBroker", false);
	g_csv.Column_Add("BidBestTime", false);
	g_csv.Column_Add("BidBest", false);
	g_csv.Column_Add("BidWorst", false);
	g_csv.Column_Add("BidOpp", false);
	g_csv.Column_Add("BidBestSpread", false);
	g_csv.Column_Add("BidWorstSpread", false);
	g_csv.Column_Add("BidWorstTime", false);
	g_csv.Column_Add("BidWorstBroker", false);
	g_csv.Column_Add("BidGap", false);
	g_csv.Column_Add("BidRealGap", false);
	g_csv.Column_Add("BidSlippagePts", false);
	g_csv.Column_Add("BidSpreadSum", false);
	g_csv.Column_Add("BidNetPLPts", false);
	g_csv.Column_Add("BidTriggered", false);

	g_csv.Column_Add("AskBestBroker", false);
	g_csv.Column_Add("AskBestTime", false);
	g_csv.Column_Add("AskBest", false);
	g_csv.Column_Add("AskWorst", false);
	g_csv.Column_Add("AskOpp", false);
	g_csv.Column_Add("AskBestSpread", false);
	g_csv.Column_Add("AskWorstSpread", false);
	g_csv.Column_Add("AskWorstTime", false);
	g_csv.Column_Add("AskWorstBroker", false);
	g_csv.Column_Add("AskGap", false);
	g_csv.Column_Add("AskRealGap", false);
	g_csv.Column_Add("AskSlippagePts", false);
	g_csv.Column_Add("AskSpreadSum", false);
	g_csv.Column_Add("AskNetPLPts", false);
	g_csv.Column_Add("AskTriggered", false);

	g_csv.Column_Add("Threshold", false);
	g_csv.Column_Add("TraceCnt", true);
	...
	LOGGING(INFO, FALSE, "-----------------------------------------------------");
	LOGGING(INFO, FALSE, "-----------------------------------------------------");
	LOGGING(INFO, FALSE, "(DIR:%s)(cnfg:%s)", g_zLogDir, g_zConfig);
