...
private:
	...
	HANDLE			m_hThread_Listen, m_hParsing, m_hThread_OrderBest, m_hThread_OrderWorst, m_hThread_Login;
	unsigned int	m_unThread_Listen, m_unParsing, m_unThread_OrderBest, m_unThread_OrderWorst, m_unThread_Login;
