...
int  _Start()
{
	...
	char zDataName[128]; sprintf(zDataName, "%s_Data", EXENAME);
	g_data.OpenLog(g_zLogDir, zDataName);


	if (!g_csv.Open(g_zLogDir, "ArbiLatencyOrderSlower", "Data", false))
	{
		//TODO
		return -1;
	}
	...
	g_csv.Column_Add("Broker_Faster", false);
	g_csv.Column_Add("Broker_Slower", false);
	
	g_csv.Column_Add("F_MDTime", false);
	g_csv.Column_Add("F_BidPrev", false);
	g_csv.Column_Add("F_BidCurr", false);
	g_csv.Column_Add("F_BidGap", false);
	g_csv.Column_Add("F_BidDirection", false);
	g_csv.Column_Add("F_AskPrev", false);
	g_csv.Column_Add("F_AskCurr", false);
	g_csv.Column_Add("F_AskGap", false);
	g_csv.Column_Add("F_AskDirection", false);
	g_csv.Column_Add("F_Spread", false);

	g_csv.Column_Add("S_MDTime", false);
	g_csv.Column_Add("S_BidPrev", false);
	g_csv.Column_Add("S_BidCurr", false);
	g_csv.Column_Add("S_BidGap", false);
	g_csv.Column_Add("S_BidDirection", false);
	g_csv.Column_Add("S_AskPrev", false);
	g_csv.Column_Add("S_AskCurr", false);
	g_csv.Column_Add("S_AskGap", false);
	g_csv.Column_Add("S_AskDirection", false);
	g_csv.Column_Add("S_Spread", false);
	
	g_csv.Column_Add("Threshold", false);
	g_csv.Column_Add("TrackingYN", true);
	...
	LOGGING(INFO, FALSE, "-----------------------------------------------------");
	LOGGING(INFO, FALSE, "-----------------------------------------------------");
	LOGGING(INFO, FALSE, "(DIR:%s)(cnfg:%s)", g_zLogDir, g_config.getFileName());
