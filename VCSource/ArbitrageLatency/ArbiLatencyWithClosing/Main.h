...
#define SERVICENAME		TEXT("ArbiLatency")
#define DISPNAME		TEXT("ArbiLatency")
#define DESC			TEXT("Arbitrage order using Latencies")
#define EXENAME			TEXT("ArbiLatency.exe")
