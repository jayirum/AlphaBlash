...
public:
	...
	static void		GetStringTrimmed(_In_ char* pOrg, int nLen, _Out_ std::string* pString);
	static string	stringFormat(const char* p, ...);
	...
	static VOID SplitData(_In_ const char* psData, _In_ const char cDelimeter, _Out_ std::list<std::string>* pListResult);
	static VOID SplitDataEx(_In_ const char* psData, _In_ const char cDelimeter, _In_ int nSize, _Out_ std::list<std::string>* pListResult);
	static VOID SplitData(_In_ const char* psData, _In_ const char cDelimeter, _Out_ std::vector<std::string>* pListResult);
...
public:
	...
	string*	Split(const string& sOrgData, char cDeli);
	int Split(const string& sOrgData, char cDeli, _Out_ vector<string>& vec);
	int		Count() { return m_nCnt; }
	void	Clear();
private:
	string* m_p;
	int m_nCnt;
