...
// ppMabValues has a ascending order
// [0]:oldest, [last]:latest

BOOL CFind_M_Shape::FindShape(const TMabValues* pMabValues, int nMabCnt)
{
	Reset();
