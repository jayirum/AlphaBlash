...
int  _Start()
{
	...
	if (g_bDebug)
		...
		CUtil::GetCnfgFileNmOfSvc(SERVICE_NAME, g_zLogDir, zConfigFileName);
...
int main(int argc, LPSTR* argv)
{
	...
	{
		{SERVICE_NAME, (LPSERVICE_MAIN_FUNCTION)ServiceStart },
		{NULL, NULL}
	};
...
void __stdcall ServiceStart(DWORD argc, LPTSTR* argv)
{
	g_hXSS = RegisterServiceCtrlHandler(SERVICE_NAME,
...
// 	prop.Close();
	...
	hSrv = CreateService(hScm, SERVICE_NAME, SERVICE_DISPNAME,
		SERVICE_ALL_ACCESS,
